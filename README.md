...
- 📝 Detailed grammar explanations with comprehensive examples
- 📊 Conjugation tables and declension charts
- 🔄 Sentence structure patterns and word order rules
- 💬 Practical vocabulary organized by topic
...
| Lesson | Topic | Key Grammar Concepts |
|--------|-------|---------------------|
| **Lektion 01** | Subordinate Clauses | Nebensätze with *weil*, *dass*, *wenn*; word order in subordinate clauses |
| **Lektion 02** | Comparative Adjectives | Komparativ & Superlativ; Adjective comparisons; clothing vocabulary |
| **Lektion 03** | Past Tense (Written) | Präteritum for regular and irregular verbs; family relationships |
| **Lektion 04** | Prepositions of Place | Two-way prepositions (Wechselpräpositionen); furniture; moving vocabulary |
| **Lektion 05** | Subjunctive Mood | Konjunktiv II for wishes, politeness, and hypothetical situations; restaurant vocabulary |
| **Lektion 06** | Reflexive Verbs | Reflexive pronouns and verbs; Genitive case; formal letter writing |
| **Lektion 07** | Past Modal Verbs | Modal verbs in past tense; sentence connectors (*dass*, *wenn*, *deshalb*); life abroad |
| **Lektion 08** | Adjective Declension | Introduction to adjective endings; health and body vocabulary |
| **Lektion 09** | Double Objects | Verbs with Dative and Accusative objects; complete adjective declension |
| **Lektion 10** | The Verb "lassen" | Multiple uses of *lassen*; Genitive case for possession; directional adverbs |
| **Lektion 11** | Passive Voice | Passiv in present, past (Präteritum), and perfect tenses; banking vocabulary |
| **Lektion 12** | Pronominal Adverbs | Question and answer structures with prepositions (*wofür*, *dafür*); travel planning |
...
5. **Build vocabulary**: Use the vocabulary sections for flashcard creation or active recall
6. **Apply concepts**: Try writing short texts or dialogues using the grammar rules learned
...
### Textbook
The curriculum follows the **"Starten Wir A2"** textbook, a comprehensive resource for German language learners at the elementary level.
...
**These notes do NOT reproduce or distribute the "Starten Wir A2" textbook.**
...
⚠️ Users should purchase the official "Starten Wir A2" textbook for complete learning materials

The **"Starten Wir A2"** textbook is copyrighted material owned by its publisher. This repository respects all intellectual property rights and serves only as a supplementary study aid for students who are using the official textbook and following the course.
...
3. Commit your changes (`git commit -m 'Fix typo in past tense conjugation'`)
